...
contract sZKFD is ERC20Permit, Ownable {
  using SafeMath for uint256;
  ...
  constructor() ERC20("sZKFD", "sZKFD", 9) ERC20Permit() {
  ...
  /**
        @notice increases sZKFD supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sZKFD
